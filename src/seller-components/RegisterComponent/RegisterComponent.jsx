      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="w-full p-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <input name="gstNumber" placeholder="GST Number (Optional)" className="p-5 border text-background text-lg rounded" onChange={handleChange} />
          </div>
        </div>
        ...
        <div className="w-full p-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="w-full flex gap-5">
              <input name="idProofUrl" placeholder="ID Proof URL" className="p-5 border text-background text-lg rounded w-full" onChange={handleChange} required />
              <button type="button" className="border rounded-lg p-2" onClick={handleFileUpload}>
                <FaCloudUploadAlt className="text-3xl text-background" />
              </button>
            </div>
        ...
        <div className="w-full p-5">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <input name="accountHolderName" placeholder="Account Holder Name" className="p-5 border text-background text-lg rounded" onChange={handleChange} required />
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-5">
          <button
            type="submit"
            disabled={loading}
            className={`w-full p-5 bg-background text-foreground hover:bg-yellow-500 text-xl font-semibold rounded-xl transition duration-200 shadow-md ${
          ...
          <a
            href="/"
            className="text-background p-5 flex gap-5 items-center justify-center border font-bold text-xl rounded"
          >
            <FaArrowLeft className="text-background text-2xl" />
            Back
          </a>
        </div>
