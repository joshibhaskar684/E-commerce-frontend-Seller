...
export default function RejectSellerModal({ setReason,reason,setOpenmodal,rejection, openModal ,sellerId,handleRejectSeller}) {
    const handleClose = () => {
                    ...
                    <div className="border flex flex-col gap-5 bg-foreground text-background p-5  md:pt-20">
                        ...
                        <div className="">
                            <h1 className="text-center ">
                                ...
                                Please Enter The Reason For Rejecting This Seller Request   
                                                        </h1>
                        </div>
    ...
    onChange={(e) => setReason(e.target.value)}
                                ...
                                <div className=" grid grid-cols-1 md:grid-cols-2 gap-5">
                                    ...
                                    <button type="submit" 
                                    disabled={rejection}
                                     className={`border cursor-pointer turncate p-5 w-full rounded font-bold text-md bg-foreground overflow-hidden text-background ${ rejection? "cursor-not-allowed bg-background text-foreground":"bg-yellow-500 "}`}>
