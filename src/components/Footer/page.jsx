...
export default function Footer() {
  return (
    <footer className="relative text-white bg-yellow-300 ">
      ...
      {/* Bottom Bar */}
      <div className="bg-background  p-5 text-center text-xs sm:text-sm text-foreground flex items-center justify-center md:justify-between ">
             <img src="/QuickLogo.png" alt="logo image   " className=' hidden md:block w-[100px] h-[50px] '></img>
   <p> © {new Date().getFullYear()} Quick. All rights reserved.
</p>
<p className=" hidden md:grid grid-cols-2 gap-3"><a>Privacy Policy</a> <a> Term Of Use</a> </p>
             </div>
    </footer>
  );
}
